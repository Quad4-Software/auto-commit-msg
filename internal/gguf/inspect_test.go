...
func TestInspect(t *testing.T) {
	...
	t.Log("arch:", f.Str("general.architecture"))
	...
	t.Log("embd:", f.U64("qwen3.embedding_length", 0))
	t.Log("layers:", f.U64("qwen3.block_count", 0))
	t.Log("heads:", f.U64("qwen3.attention.head_count", 0))
	t.Log("kv heads:", f.U64("qwen3.attention.head_count_kv", 0))
	t.Log("rope base:", f.F32("qwen3.rope.freq_base", 0))
	t.Log("rope dim:", f.U64("qwen3.rope.dimension_count", 0))
